...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
	...
	/**
	 * AbstractPlatformTransactionManager 类的常量实例
	 * <p>
	...
	/**
	 * 根据事务定义获取事务状态；
	 * 实现了事务传播行为，委托给模板方法 doGetTransaction、isExistingTransaction、doBegin
	 * <p>
	...
	/**
	 * 为已存在的事务创建 TransactionStatus
	 * <p>
	 * Create a TransactionStatus for an existing transaction.
	 *
	 * @param definition   获取事务时的事务定义
	...
	/**
	 * 创建新的 TransactionStatus，并执行事务同步
	 * <p>
	...
	protected final SuspendedResourcesHolder suspend(@Nullable Object transaction) throws TransactionException {
		if (TransactionSynchronizationManager.isSynchronizationActive()) {
			// TransactionSynchronization 已激活

			// 先挂起 TransactionSynchronization
			...
			// TransactionSynchronization 未激活，存在事务，挂起已存在事务中的资源
	...
	/**
	 * 挂起并返回 TransactionSynchronization
	 * <p>
	...
	/**
	 * TransactionSynchronization 执行恢复
	 * <p>
	 ...
	 * 获取已存在事务；
	 * <p>
	 * 该对象可直接或作为 DefaultTransactionStatus 实例的一部分传递到其他模板方法；
	 * 返回的事务对象包含 #getTransaction 方法调用之前的事务信息；
	 * <p>
	...
	protected static final class SuspendedResourcesHolder {
		...
		/**
		 * 挂起的资源（ConnectionHolder）
		 */
		@Nullable
		private final Object suspendedResources;

		/**
		 * 挂起的 TransactionSynchronization
		 */
		@Nullable
