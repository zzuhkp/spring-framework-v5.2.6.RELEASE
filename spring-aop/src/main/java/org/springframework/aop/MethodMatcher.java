...
/**
 * Pointcut 的一部分，检查目标方法是否为合适的 Advice
 * 1. 如果 #isRuntime 方法返回 true 只会调用两个参数的 #matches 方法
 * 2. 如果 #isRuntime 方法返回 false，并且两个参数的 #matches 方法返回true 则会调用三个参数的 #matches 方法
 * <p>
...
public interface MethodMatcher {
	...
	/**
	 * 当前 MethodMatcher 是否为动态的，也就是说调用两个参数的 #matches 方法后是否还需要调用三个参数的 #matches 方法
	 * <p>
