...
public class TypeDescriptor implements Serializable {
	...
	/**
	 * 原始类型，可能表示字段，方法参数类型，方法返回值类型
	 */
	private final Class<?> type;

	/**
	 * 表示泛型的类型，可能表示字段，方法参数类型，方法返回值类型
	 */
	private final ResolvableType resolvableType;

	/**
	 * 注解元素，可能表示方法上的注解或方法参数的注解或字段的注解
	 */
	...
	/**
	 * {@link #getType()}的变体，可以将基本类型转换为包装类型
	 * <p>
	...
	/**
	 * 通过设置给定值的类型来缩小当前{@link TypeDescriptor}表示的类型范围。
	 * <p>
	...
	/**
	 * 将当前{@link TypeDescriptor}转换为父类或实现的接口
	 * <p>
