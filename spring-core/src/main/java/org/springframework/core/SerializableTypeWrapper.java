...
/**
 * <p>
 * 内部的工具类，用于获取包装{@link java.lang.reflect.Type java.lang.reflect.Types}的{@link Serializable}变体。
 * <p>
 * {@link #forField(Field) Fields}或者{@link #forMethodParameter(MethodParameter) MethodParameters}可以用作序列化类型的根源。
 * 或者常规类也可以作为源。
 * <p>
 * 返回的类型是{@link Class}，
 * 或者{@link GenericArrayType}, {@link ParameterizedType}, {@link TypeVariable}，{@link WildcardType}的序列化代理。
 * 除了final {@link Class} ,方法的调用返回的{@link Type Types}将被自动包装（如{@link GenericArrayType#getGenericComponentType()})
 *
 * <p>
