...
/**
 * 提供了一种以一致的顺序访问注解的属性方法以及一些有用的实用程序方法。
 * <p>
...
final class AttributeMethods {
	...
	/**
	 * 确定是否可以安全地访问给定注解中的值而不会导致任何TypeNotPresentException。
	 * <p>
	...
	/**
	 * 检查是否可以安全访问给定注解中的值，而不会导致任何TypeNotPresentException。
	 * 特别是，这个方法被设计用来覆盖谷歌应用引擎对于Class值的这种异常的延迟到达（而不是更典型的早期异常）
	 * <p>
	...
	/**
	 * 确定指定索引处的属性在访问时是否可以引发TypeNotPresentException。
	 *
	...
	/**
	 * 获取具有指定名称的属性的索引，如果没有具有该名称的属性，则获取-1。
	 *
