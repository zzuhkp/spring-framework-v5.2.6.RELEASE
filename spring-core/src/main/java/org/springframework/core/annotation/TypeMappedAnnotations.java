...
/**
 * {@link MergedAnnotations} implementation that searches for and adapts annotations and meta-annotations using {@link
...
final class TypeMappedAnnotations implements MergedAnnotations {
	...
	/**
	 * 给定的注解类型是否和AnnotationTypeMapping保持的类型一致
	 *
	 * @param mapping
