...
/**
 * 解析字符串值的策略接口，ConfigurableBeanFactory类解析别名使用
 * <p>
...
public interface StringValueResolver {
	 ...
	 *
	 * @param strVal 源字符串值，不能为null
	 *               the original String value (never {@code null})
	 * @return 可以为null或者字符串值本身
	 * the resolved String value (may be {@code null} when resolved to a null
	 ...
	 * @throws IllegalArgumentException 无法解析字符串值时
