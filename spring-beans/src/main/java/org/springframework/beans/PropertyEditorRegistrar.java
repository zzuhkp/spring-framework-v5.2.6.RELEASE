...
/**
 * 用于在 PropertyEditorRegistry 中注册自定义 PropertyEditor 的策略的接口。
 * <p>
...
public interface PropertyEditorRegistrar {
	...
	/**
	 * 使用给定的PropertyEditorRegistry注册自定义PropertyEditor。
	 * 传入的注册表通常是BeanWrapper或DataBinder。
	 * 预期实现将为该方法的每次调用创建全新的PropertyEditor实例（因为PropertyEditor不是线程安全的）。
	 * <p>
